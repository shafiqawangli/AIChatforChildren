...
<body>
    ...
    <script>
        ...
        async function deleteChat(chatId) {
            ...
            try {
                const result = await apiRequest('/delete', 'POST', {
                    id: chatId
                });
                if (result.success) {
        ...
        function markdownToPlainText(text) {
            ...
            return sanitizeSpeechText(rawText);
        }
        ...
        function sanitizeSpeechText(text) {
            ...
            // Remove markdown-style emoji/sticker shorthand like :smile:
            let sanitized = text.replace(/:[^:\s]+:/g, '');

            // Remove emoji and pictographic symbols for speech output.
            try {
                sanitized = sanitized.replace(/\p{Extended_Pictographic}/gu, '');
            } catch (e) {
                sanitized = sanitized.replace(/[\u231A-\u27BF\u1F000-\u1F6FF\u1F900-\u1F9FF\u2600-\u26FF]/g, '');
            }
